...
class Rider extends SpriteAnimationGroupComponent<RiderState>
  ...
  Future<void> reverse(LogicalKeyboardKey? arrow) async {
    var run = CharacterConstants.riderMountRun;
    var idle = CharacterConstants.riderMountIdle;

    if (arrow == LogicalKeyboardKey.arrowLeft) {
      run = CharacterConstants.riderMountRunReverse;
      idle = CharacterConstants.riderMountIdleReverse;
    }
